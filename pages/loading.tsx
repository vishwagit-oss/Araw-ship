    ...
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input name="igValue" type="number" value={form.igValue} onChange={handleChange} className="w-full border p-2 mb-2" />

          <label className="block font-semibold">AED Price</label>
          <input name="aedPrice" type="number" value={form.aedPrice} onChange={handleChange} className="w-full border p-2 mb-2" />

          <label className="block font-semibold">Total Paid</label>
          <input name="totalPaid" type="number" value={form.totalPaid} onChange={handleChange} className="w-full border p-2 mb-2" />

          <label className="block font-semibold">Customer Money Received</label>
          <input name="customerMoney" value={form.customerMoney} onChange={handleChange} className="w-full border p-2 mb-2" />
        </div>
        ...
        <div>
          ...
          <input name="mtValue" type="number" value={form.mtValue} onChange={handleChange} className="w-full border p-2 mb-2" />

          <label className="block font-semibold">USD</label>
          <input name="usdRate" type="number" value={form.usdRate} onChange={handleChange} className="w-full border p-2 mb-2" />

          <label className="block font-semibold">Total Value in AED</label>
          <input name="totalValueAED" value={form.totalValueAED} readOnly className="w-full border p-2 bg-gray-100" />
        </div>
      </div>
